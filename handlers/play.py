...
async def play(_, message: Message):
    ...
    try:
        ...
        await lel.edit(
            "<i> @VCPlayRobot Userbot not in this chat, Ask admin to send /play command for first time or add assistant manually</i>"
        )
    ...
    if message.chat.id in callsmusic.pytgcalls.active_calls:
        ...
        await message.reply_photo(
            photo="final.png",
            reply_markup=keyboard,
            caption=f"✯𝗩𝗖𝗣𝗹𝗮𝘆✯▶️ **Playing** here the song requested by {message.from_user.mention()} 😜",
        )
